...
#elif defined (CONFIG_LV_PREDEFINED_DISPLAY_TTGO)
#define TFT_SPI_HOST VSPI_HOST
#else
#error Neither CONFIG_LV_TFT_DISPLAY_SPI_HSPI, CONFIG_LV_TFT_DISPLAY_SPI_VSPI or CONFIG_LV_TFT_DISPLAY_SPI_FSPI is defined
#endif
